				...
				<div class="container-fluid">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="<?= base_url('pengguna/export_print_lihat') ?>" target="_blank" class="btn btn-primary btn-sm"><i
									class="fa fa-print"></i>&nbsp;&nbsp;Print</a>
							<a href="<?= base_url('pengguna/export_pdf_lihat') ?>" target="_blank" class="btn btn-danger btn-sm"><i
