				...
				<div class="container-fluid">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="<?= base_url('penjualan/export_print_detail_penjualan/' . $penjualan->no_penjualan) ?>"
								class="btn btn-primary btn-sm"><i class="fa fa-print"></i>&nbsp;&nbsp;Print</a>
							<a href="<?= base_url('penjualan/export_pdf_detail_penjualan/' . $penjualan->no_penjualan) ?>"
					...
					<div class="card shadow">
						<div class="card-header"><strong>Detail Penjualan - <?= $penjualan->no_penjualan ?></strong>
						</div>
						<div class="card-body">
							<div class="row">
								<div class="col-md-6">
										...
										<tbody>
											<?php foreach ($all_detail_penjualan as $detail_penjualan): ?>
												<tr>
													...
													<td>Rp
														<?= number_format($detail_penjualan->harga_barang, 0, ',', '.') ?>
													</td>
													<td><?= $detail_penjualan->jumlah_barang ?>
														<?= strtoupper($detail_penjualan->satuan) ?>
													</td>
													<td>Rp <?= number_format($detail_penjualan->sub_total, 0, ',', '.') ?>
													</td>
												</tr>
											<?php endforeach ?>
										</tbody>
