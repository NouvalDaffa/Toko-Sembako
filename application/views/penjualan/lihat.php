				...
				<div class="container-fluid">
					<div class="clearfix">
						...
						<div class="float-right">
							<a href="<?= base_url('penjualan/export_print_lihat') ?>" target="_blank" class="btn btn-primary btn-sm"><i
									class="fa fa-print"></i>&nbsp;&nbsp;Print</a>
							<a href="<?= base_url('penjualan/export_pdf_lihat') ?>" target="_blank" class="btn btn-danger btn-sm"><i
									...
									<tbody>
										<?php foreach ($all_penjualan as $penjualan): ?>
											<tr>
												...
												<td><?= $penjualan->tgl_penjualan ?> Pukul <?= $penjualan->jam_penjualan ?>
												</td>
												<td>Rp <?= number_format($penjualan->total, 0, ',', '.') ?></td>
												<td>
													<a href="<?= base_url('penjualan/detail/' . $penjualan->no_penjualan) ?>"
